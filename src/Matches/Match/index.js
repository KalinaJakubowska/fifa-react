    ...
    return (
        <div onClick={onMatchClick} className={`match${selectedMatch === id ? " match--selected" : ""}`}>
            ...
            <div className="match__item match__item--goal">
                {selectedMatch === id ? <input type="number" className="match__input" value={match.goal1} onChange={onChange1} /> : match.goal1}

            </div>
            <div className="match__item match__item--vs">VS</div>
            <div className="match__item match__item--goal">
                {selectedMatch === id ? <input type="number" className="match__input" value={match.goal2} onChange={onChange2} /> : match.goal2}
            </div>
